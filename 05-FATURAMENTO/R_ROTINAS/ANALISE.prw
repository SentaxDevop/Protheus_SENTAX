...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÉÍÍÍÍÍÍÍÍÍÍÑÍÍÍ ÍÍÍÍÍÍÍËÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍ»±±
±±ºPrograma  ³OMSB005  ºAutor  ³Reinaldo Dias        º Data ³  19/08/2005 º±±
...
*/
@ 180,115 BUTTON OemtoAnsi("Alterar SB9") SIZE 50,12 ACTION fAjustSB9("SALDO_SB9") PIXEL OF oFolder:aDialogs[1]
@ 180,180 BUTTON OemtoAnsi("Alterar SB2") SIZE 50,12 ACTION fAjustSB2("SALDO_SB2") PIXEL OF oFolder:aDialogs[1]
...
@ 001,250 BUTTON "Alterar Saldo A Classificar SB2" SIZE 80,10 ACTION (fAjustSB2("CLASS_SB2"))     PIXEL OF oFolder:aDialogs[8] 
...
@ 121,420 BUTTON "Alterar"     SIZE 30,10 ACTION (fAjustSDA("DAxB8"))   PIXEL OF oFolder:aDialogs[8]
...
@ 001,180 BUTTON "Incluir SD5"     SIZE 30,10 ACTION (fAjustSD5("D5_I","13"))                         PIXEL OF oFolder:aDialogs[13]
@ 001,240 BUTTON "Incluir SDB"     SIZE 30,10 ACTION (fAjustSDB("DB_I","13"))                         PIXEL OF oFolder:aDialogs[13]
@ 001,300 BUTTON "Alterar"         SIZE 30,10 ACTION (fAjustD5DB("D5DB_A"))                           PIXEL OF oFolder:aDialogs[13]
