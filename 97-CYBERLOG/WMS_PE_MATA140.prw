...
// @author Layze Fuzinato 
// @date 25/03/2021
// @description Integração WMS 

User Function MTA140MNU()
	AAdd( aRotina, { "WMS - Cyberlog"		, "U_fPnlWMSNF()"		, 0 , 2, 0, NIL})
Return 
...
For nX:=1 to len(aItens)
	...
	If aItens[nX,01]
		...
		lIntegra:= .T.//GetAdvFVal("SBZ","BZ_XINTWMS",xFilial("SBZ")+SD1->D1_COD,1) == "S"
